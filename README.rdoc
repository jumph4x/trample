...
git clone git://github.com/jumph4x/trample.git
...
gem install trample-0.1.0.gem

gem install sevenwire-rest-client -s http://gems.github.com
...
= Randomizer
 ramdomizer builds various strings to POST into forms to load test data
